...
<div style="display: flex; gap: 32px; align-items: flex-start; flex-wrap: wrap;">
  ...
  <div style="flex: 1 1 260px; min-width: 0;">
    <img src="{{ site.url }}/images/publications/JAPP_cover1.png" alt="Journal of Asian Public Policy cover (2024)" style="width: 100%; max-width: 260px; height: auto; margin-top: 28px; border: 1px solid #e3e3e3; border-radius: 6px; box-shadow: 0 1px 5px rgba(0,0,0,.10); display: block;">
